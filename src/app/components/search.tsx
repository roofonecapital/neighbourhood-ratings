      ...
      <>
         <div className="flex flex-col items-center justify-center relative">
            <div className="flex justify-center mt-8">
               <Command
                  className="rounded-lg border shadow-md w-[300px] md:w-[540px] bg-white"
                  shouldFilter={false}
               >
                  <CommandInput
               ...
               <button
                  type="button"
                  className="rounded-r-lg h-[52px] -ml-24 w-36 md:w-48 bg-roofone-green-primary mt-[0.75px] px-4 py-2.5 text-xs font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
               >
                  Calculate rating
               </button>
            </div>
